    ...
    <div className="flex flex-col items-center justify-center w-screen min-h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
      ...
      <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        ...
        <div className="grid grid-cols-1 gap-8 mx-auto lg:grid-cols-2 ">
          ...
          <h2 className="mb-0 text-3xl font-bold tracking-tight text-zinc-100 sm:text-4xl">
            Contact
          </h2>
        <div className="mt-0 container flex items-center justify-center min-h-screen px-4 mx-auto">
          
				<div className="mt-0 grid w-full grid-cols-1 gap-8 mx-auto sm:grid-cols-3 lg:gap-16">
					{socials.map((s) => (
						<Card>
							<Link
								href={s.href}
